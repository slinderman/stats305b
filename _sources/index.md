...
| Wed, Feb  22, 2025 | [Sparse GLMs](lectures/06_sparse_glms.ipynb) | [download](slides/06_sparse_glms.pdf) | {cite:p}`friedman2010regularization` and {cite:p}`lee2014proximal`|
