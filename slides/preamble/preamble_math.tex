...
\newcommand{\ind}[1]{\stackrel{\text{ind}}{#1}}
...
\newcommand{\distSt}{\mathrm{St}}
\newcommand{\distWishart}{\mathrm{W}}
\newcommand{\distUniform}{\mathrm{Unif}}
\newcommand{\distInvChiSq}{\chi^{-2}}
